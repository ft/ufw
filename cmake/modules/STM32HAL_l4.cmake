if(__UFW_STM32HAL_l4)
  return()
endif()
set(__UFW_STM32HAL_l4 1)

set(__UFW_STM32HAL_l4_HIGH_SOURCES
  stm32l4xx_hal.c
  stm32l4xx_hal_adc.c
...
set(__UFW_STM32HAL_l4_LOW_SOURCES
  stm32l4xx_ll_adc.c
  stm32l4xx_ll_comp.c
  stm32l4xx_ll_crc.c
  stm32l4xx_ll_crs.c
...
set(__UFW_STM32HAL_l4_LEGACY_SOURCES Legacy/stm32l4xx_hal_can.c)
