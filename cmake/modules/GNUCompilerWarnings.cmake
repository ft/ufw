...
macro(MakeStrictCCompiler)
  ...
  if (UFW_CC_HAS_Wasm)
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wasm")
  endif()
  if (UFW_CC_HAS_Wimplicit_fallthrough)
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wimplicit-fallthrough=3")
  endif()
  ...
  if (UFW_CC_HAS_Wpacked)
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wpacked")
  endif()
  if (UFW_CC_HAS_Wpadded)
  ...
  if (UFW_CC_HAS_Wshift_sign_overflow)
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wshift-sign-overflow")
  endif()
  ...
  if (UFW_CC_HAS_Wused_but_marked_unused)
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wused-but-marked-unused")
  endif()
endmacro()

macro(MakeFatallyStrictCCompiler)
...
macro(MakeStrictCXXCompiler)
  ...
  if (UFW_CXX_HAS_Wasm)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wasm")
  endif()
  ...
  if (UFW_CXX_HAS_Wpacked)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wpacked")
  endif()
  if (UFW_CXX_HAS_Wpadded)
...
macro(MakeFatallyStrictCXXCompiler)
  if (UFW_CXX_HAS_Werror)
    set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS} -Werror")
  endif()
endmacro()
