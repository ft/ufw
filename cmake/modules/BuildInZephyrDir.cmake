...
function(ufw_zephyr_modules params root modules)
  ...
  set(${params} "-DZEPHYR_MODULES=${_return}" PARENT_SCOPE)
  if (${UFW_ZEPHYR_DEBUG})
...
function(ufw_zephyr_toolchain name root params)
  set(_return -DZEPHYR_TOOLCHAIN_VARIANT=${name})
  if (${name} STREQUAL gnuarmemb)
    if (NOT ("${root}" STREQUAL ""))
      list(APPEND _return -DGNUARMEMB_TOOLCHAIN_PATH=${root})
    endif()
  endif()
...
function(ufw_build_zephyr)
  ...
  set(__multi_args MODULES OPTIONS)
