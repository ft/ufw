...
function(generate_version_h)
  ...
  if (${PARSED_ARGS_SYSTEM_VERSION})
    # Set these in parent scope so later invocations can pick them up.
    set(UFW_SYSTEM_WITH_VERSION_H 1 PARENT_SCOPE)
    set(UFW_SYSTEM_VERSION_HEADER ${PARSED_ARGS_OUTPUT} PARENT_SCOPE)
  else()
...
function(generate_commitdate_file)
  cmake_parse_arguments(
    PARSED_ARGS
    ""
    "TARGET;OUTPUT;PREFIX"
